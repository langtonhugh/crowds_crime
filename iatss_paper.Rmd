...
The team found a temporal variation in vehicles crimes, and there was some evidence to suggest an association with crowding. In a typical day during June, vehicle crime counts peaked during the afternoon rush hour and remained high into the evening (see Figure 1). The team found a positive, statistically significant relationship between footfall counts and crowding, providing support for their hypothesis. However, marginal effects models suggested that the nature of this relationship (strength and direction) varied depending on the time of day.
...
In this paper we have reported on the design and outputs from a community-orientated open research format to tackle research questions on crowds, safety and crime. Contributions from the event are twofold. First, participants actively contributed to the field's scientific evidence-base. Using novel data sources from Retrosheet and Safegraph, teams produced theoretically-driven findings which described and explained the temporal and spatial relationships between crowding and police-recorded crime. Teams intend to advance these analyses for publication in crime science and geography journals. Secondly, the hackathon-style event showcases the benefits and importance of a community-driven, open research format. In reporting the event design here, we hope to provide a template and inspire future events to examine topics in criminology, policing and urban analytics.
